                            ...
                            <table id="table" class="table"  cellspacing="0" width="100%">
                                ...
                                @foreach($tutors as $key=>$tutor)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('tutor.edit',$tutor->id) }}" class="btn btn-info btn-sm"><i class="material-icons">mode_edit</i></a>

                                            <form id="delete-form-{{ $tutor->id }}" action="{{ route('tutor.destroy',$tutor->id) }}" style="display: none;" method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
